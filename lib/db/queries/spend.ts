  ...
  await db
    ...
    .values(
      entries.map((e) => ({
        ...
        name: e.name ?? null,
        role: e.role ?? null,
        spendCents: e.spendCents ?? 0,
        overallSpendCents: e.overallSpendCents ?? 0,
        fastPremiumRequests: e.fastPremiumRequests ?? 0,
        hardLimitOverrideDollars: e.hardLimitOverrideDollars ?? 0,
